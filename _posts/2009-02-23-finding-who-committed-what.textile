...
Zeile verantwortlich ist und aus welcher Übergabe (Commit) sie kam.
...
Die Textwand mag einige von euch verwirren. Sie zeigt den verkürzten SHA der
Übergabe (Commits), den Dateinamen, den Autor, das Datum, die Zeilennummer und
die tatsächliche Quellcodezeile.
...
der E-Mail der Übergabe (Commits), ältere Übergaben (Commits) werden mit einem
dunkleren grauen Hintergrund dargestellt.
