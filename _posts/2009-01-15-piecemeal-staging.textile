...
This is a follow up to the comments from yesterday's article about "interactive adding":http://gitready.com/2009/01/14/interactive-adding.html. 

Git's @add --patch@ mode is very similar to interactive adding, but it has a lot more power. This command is capable ofbreaking up commits in files into smaller hunks so you can commit *exactly* what you want, and not just the whole file. 
