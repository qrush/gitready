...
Jetzt, wo das entfernte Repository, die Gegenstelle, aktualisiert ist und wenn du auf GitHub vorbei schaust, "kannst du die Bereitstellungen (Commits) sehen":http://github.com/qrush/gitready/commits/master. Die Kommandoausgabe gibt an, wie Git die geänderten Datenblobs überträgt und läßt uns wissen, dass das Repository aktualisiert ist, indem es den geänderten SHA1-Hash zeigt.

Aber was ist mit @pull@? Wir können es zum Abgleich der soeben gemachten Bereitstellungen mit jeglichen Repositories verwenden. Das Projekt-Deployment Script macht genau das:
