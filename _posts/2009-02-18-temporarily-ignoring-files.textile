...
Commit-Objekt hinzufügt. Das ist eine nützliche Abkürzung, vergewissere dich
...
Datei direkt zum Index hinzugefügt. Das Zusammenführen (Merge) einer Änderung
...
Wenn ich @git commit -a@ an dieser Stelle ausführe, würden alle Dateien zum
neuen Commit hinzugefügt. Ich möchte jedoch die Änderungen in einer Datei
temporär ignorieren:
...
hat. Von da an könntest du die Änderungen zu einem neuen Commit hinzufügen oder
"auf die aktuelle Kopie
