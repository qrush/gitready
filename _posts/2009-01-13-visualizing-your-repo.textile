...
This will fire up a server, usually "Thin":http://code.macournoyer.com/thin/, to serve a simple web interface for your repository. You can browse commits, trees, view files, what have you. 

p=. !/images/instaweb.png!

This is really useful if you need to dive down and see history but you don't know the commands yet. (And it's easier too.) If you don't have Thin installed and don't want to bother with it, running

@git instaweb --httpd webrick@

will force WEBrick to serve the page, which will work just as well if Ruby is installed on your system.
