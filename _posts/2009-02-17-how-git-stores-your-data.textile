...
ziemlich jedes Objekt, sei es ein Commit, Baum oder ein Binärobjekt hat einen SHA,
lerne also sie zu lieben. Glücklicherweise sind sie durch eine einfache
Zeichenfolge aus sechs Zeichen referenziert, die in der Regel ausreichen die
gesamte Zeichenkette zu identifizieren.
...
Das bringt uns schließlich zum wichtigsten Objekt: Der Commit. Man kann sich
Commits als Schnappschüsse vorstellen: Sie wissen wie der Baum zu einem
bestimmten Zeitpunkt aussah. Darüber hinaus halten sie weitere Informationen
wie Autor, Datum und Nachricht vor.

p=. !/images/object3.png!

Commits werden in "gerichteten azyklischen
...
es bedeuted, dass Commits in eine Richtung "fließen". Gewöhnlich ist diese
Richtung einfach der Weg der Geschichte in deinem Repository, die recht
einfach oder recht kompliziert sein kann, wenn du viele Zweige hast. Von einem
umfassenden Standpunkt aus betrachtet, kann es wie folgt aussehen:
...
offensichtlich. Ganz klar können hier die Commit-Objekte und ihre assoziierten
Daten betrachtet werden.

p=. !/images/object5.png!

Wenn du nun einige komische Terminologien in deinen Commits findest, wirst ein wenig
besser verstehen, wo sie herkommen und wie es funktioniert. Schau einfach mal in der interessanten
Anleitung "Git for Computer
Scientists":http://eagain.net/articles/git-for-computer-scientists/ und in "Scott
Chacon's":http://jointheconversation.org Referat zu "Getting
