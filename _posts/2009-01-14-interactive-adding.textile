...
Sobald wir Update 1 auswählen, wird uns mitgeteilt, dass die Datei für die Übergabe bereitgestellt ist. Wenn wir in den Status schauen, sehen wir, dass unsere Readme korrekt bereitgestellt ist.
...
Sobald du fertig bist, kannst du mit dem @quit@ Kommando abschließen und deine Arbeit wird übergeben (Commit). Solltest du dem interaktiven Modus nicht trauen, zeigt dir @git status@, dass nur die Readme für die Übergabe bereitgestellt wurde:
