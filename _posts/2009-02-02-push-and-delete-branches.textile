...
So let's say you have "checked out a new branch":http://0.0.0.0:4000/beginner/2009/01/25/branching-and-merging.html, committed some awesome changes, but now you need to share this branch though with another developer. You can push the branch up to a remote very simply:
