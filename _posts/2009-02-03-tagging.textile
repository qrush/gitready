...
The second describe command shows us that we're one commit ahead of where the last tag was done. This is an easy way to figure out how much work has been done since the last commit. On GitHub (or on your remote) you'll see the tag pushed up:
