...
Probably the easiest option is doing a @git diff@. It will print out the lines that have changed in all files compared to @HEAD@, or the last commit. So changing just one line in a README file would give me this output:
